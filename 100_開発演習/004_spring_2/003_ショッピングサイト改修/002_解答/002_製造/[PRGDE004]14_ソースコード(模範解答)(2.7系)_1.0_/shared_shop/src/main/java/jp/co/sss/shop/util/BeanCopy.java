...
public class BeanCopy {
	...
	/**
	 * Userエンティティの各フィールドの値をUserBeanクラスにコピー
	 *
	 * @param entity コピー元のユーザーEntity
	 * @return コピー先のユーザーBean
	 */
	public static UserBean copyUserEntityToUserBean(User entity) {
	...
	/**
	 * Userエンティティの各フィールドの値をUserFormクラスにコピー
	 * @param entity User
	 * @return UserForm
	 */
	public static UserForm copyUserToUserForm(User entity) {
	...
	/**
	 * UserBeanの各フィールドの値をUserFormクラスにコピー
	 * @param entity User
	 * @return UserForm
	 */
	public static UserForm copyUserBeanToUserForm(UserBean bean) {
	...
	/**
	 * UserFormの各フィールドの値をUserEntityクラスにコピー
	 * @param form UserForm
	 * @return UserEntity
	 */
	public static User copyUserFormToUser(UserForm form) {
