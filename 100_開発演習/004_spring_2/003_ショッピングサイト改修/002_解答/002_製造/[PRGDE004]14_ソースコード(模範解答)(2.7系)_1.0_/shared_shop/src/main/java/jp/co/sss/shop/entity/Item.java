...
@Table(name = "items")
//@NamedNativeQueries({
//@NamedNativeQuery(name = "findItemsInnerOrderItemOrderCnt",
//					query = JPQLConstant.FIND_ITEMS_INNER_ORDERITEMS_ORDERCNT,
//					resultClass = Item.class),
//@NamedNativeQuery(name = "findItemsOuterOrderItemOrderCnt",
//					query = JPQLConstant.FIND_ITEMS_OUTER_ORDERITEMS_ORDERCNT,
//					resultClass = Item.class)
//})
public class Item {
	/**
